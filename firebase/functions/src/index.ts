...
import { translateText, detectLanguage, translateMessage } from './translation';
...
export const detectLang = detectLanguage;
export const messageTranslated = translateMessage;
