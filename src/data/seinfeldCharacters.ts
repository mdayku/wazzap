...
export type SeinfeldCharacter = 'Jerry' | 'George' | 'Elaine' | 'Kramer';

export interface CharacterProfile {
  uid: string; // Firebase user ID (to be created)
  ...
  speechPattern: {
    ...
    exclamationFrequency: number; // 0-1, how often they use !
    questionFrequency: number; // 0-1, how often they ask questions
    ellipsisFrequency: number; // 0-1, how often they trail off...
    capsFrequency: number; // 0-1, how often they YELL
  };
  topicPreferences: {
    loves: string[]; // Topics they bring up often
    hates: string[]; // Topics they complain about
    neutral: string[];
  };
  responseStyle: string;
}

export const JERRY_PROFILE: CharacterProfile = {
...
export const GEORGE_PROFILE: CharacterProfile = {
  uid: 'seinfeld_george',
  character: 'George',
...
export const ELAINE_PROFILE: CharacterProfile = {
  uid: 'seinfeld_elaine',
  character: 'Elaine',
...
export const KRAMER_PROFILE: CharacterProfile = {
  uid: 'seinfeld_kramer',
  character: 'Kramer',
...
export function getCharacterProfile(character: SeinfeldCharacter): CharacterProfile {
  return ALL_CHARACTERS.find(c => c.character === character)!;
}

export function getCharacterByUid(uid: string): CharacterProfile | undefined {
  return ALL_CHARACTERS.find(c => c.uid === uid);
}
